...
const (
	...
	WorkflowTypePreprocessing WorkflowType = "preprocessing"
	// poststorage runs after AIP storage.
	WorkflowTypePoststorage WorkflowType = "poststorage"
	// postbatch runs after ingesting a batch of SIPs.
	WorkflowTypePostbatch WorkflowType = "postbatch"
)
...
var _WorkflowTypeNames = []string{
	string(WorkflowTypePreprocessing),
	string(WorkflowTypePoststorage),
	string(WorkflowTypePostbatch),
}
...
var _WorkflowTypeValue = map[string]WorkflowType{
	"preprocessing": WorkflowTypePreprocessing,
	"poststorage":   WorkflowTypePoststorage,
	"postbatch":     WorkflowTypePostbatch,
}
