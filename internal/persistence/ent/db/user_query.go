...
func (uq *UserQuery) QueryUploadedSips() *SIPQuery {
	query := (&SIPClient{config: uq.config}).Query()
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withUploadedSips: uq.withUploadedSips.Clone(),
...
func (uq *UserQuery) WithUploadedSips(opts ...func(*SIPQuery)) *UserQuery {
	query := (&SIPClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withUploadedSips = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withUploadedSips; query != nil {
		if err := uq.loadUploadedSips(ctx, query, nodes,
...
func (uq *UserQuery) loadUploadedSips(ctx context.Context, query *SIPQuery, nodes []*User, init func(*User), assign func(*User, *SIP)) error {
