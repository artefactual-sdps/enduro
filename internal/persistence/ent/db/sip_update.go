...
func (_u *SIPUpdate) SetChecksumValue(v string) *SIPUpdate {
	_u.mutation.SetChecksumValue(v)
	return _u
}

// SetNillableChecksumValue sets the "checksum_value" field if the given value is not nil.
func (_u *SIPUpdate) SetNillableChecksumValue(v *string) *SIPUpdate {
	if v != nil {
		_u.SetChecksumValue(*v)
	}
	return _u
}

// ClearChecksumValue clears the value of the "checksum_value" field.
func (_u *SIPUpdate) ClearChecksumValue() *SIPUpdate {
	_u.mutation.ClearChecksumValue()
	return _u
}
...
func (_u *SIPUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.ChecksumValue(); ok {
		_spec.SetField(sip.FieldChecksumValue, field.TypeString, value)
	}
	if _u.mutation.ChecksumValueCleared() {
		_spec.ClearField(sip.FieldChecksumValue, field.TypeString)
	}
...
// SetChecksumValue sets the "checksum_value" field.
func (_u *SIPUpdateOne) SetChecksumValue(v string) *SIPUpdateOne {
	_u.mutation.SetChecksumValue(v)
	return _u
}

// SetNillableChecksumValue sets the "checksum_value" field if the given value is not nil.
func (_u *SIPUpdateOne) SetNillableChecksumValue(v *string) *SIPUpdateOne {
	if v != nil {
		_u.SetChecksumValue(*v)
	}
	return _u
...
// ClearChecksumValue clears the value of the "checksum_value" field.
func (_u *SIPUpdateOne) ClearChecksumValue() *SIPUpdateOne {
	_u.mutation.ClearChecksumValue()
	return _u
}
