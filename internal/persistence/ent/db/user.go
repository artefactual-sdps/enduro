...
type User struct {
	...
	// JwtIss holds the value of the "jwt_iss" field.
	JwtIss string `json:"jwt_iss,omitempty"`
	// JwtSub holds the value of the "jwt_sub" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldEmail, user.FieldName, user.FieldJwtIss, user.FieldJwtSub:
...
func (u *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldJwtIss:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field jwt_iss", values[i])
			} else if value.Valid {
				u.JwtIss = value.String
			}
		case user.FieldJwtSub:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field jwt_sub", values[i])
			} else if value.Valid {
				u.JwtSub = value.String
			}
		default:
...
func (u *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("jwt_iss=")
	builder.WriteString(u.JwtIss)
	builder.WriteString(", ")
	builder.WriteString("jwt_sub=")
	builder.WriteString(u.JwtSub)
	builder.WriteByte(')')
