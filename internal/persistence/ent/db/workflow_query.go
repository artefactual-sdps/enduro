...
func (_q *WorkflowQuery) QuerySip() *SIPQuery {
...
func (_q *WorkflowQuery) WithSip(opts ...func(*SIPQuery)) *WorkflowQuery {
	query := (&SIPClient{config: _q.config}).Query()
...
func (_q *WorkflowQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Workflow, error) {
	...
	if query := _q.withSip; query != nil {
		if err := _q.loadSip(ctx, query, nodes, nil,
			func(n *Workflow, e *SIP) { n.Edges.Sip = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *WorkflowQuery) loadSip(ctx context.Context, query *SIPQuery, nodes []*Workflow, init func(*Workflow), assign func(*Workflow, *SIP)) error {
...
func (_q *WorkflowQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withSip != nil {
			_spec.Node.AddColumnOnce(workflow.FieldSipID)
		}
	}
