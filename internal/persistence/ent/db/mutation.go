...
func (m *UserMutation) SetJwtIss(s string) {
	m.jwt_iss = &s
}

// JwtIss returns the value of the "jwt_iss" field in the mutation.
func (m *UserMutation) JwtIss() (r string, exists bool) {
	v := m.jwt_iss
	if v == nil {
		return
	}
...
// OldJwtIss returns the old "jwt_iss" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldJwtIss(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldJwtIss is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldJwtIss requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldJwtIss: %w", err)
	}
	return oldValue.JwtIss, nil
}

// ClearJwtIss clears the value of the "jwt_iss" field.
func (m *UserMutation) ClearJwtIss() {
	m.jwt_iss = nil
	m.clearedFields[user.FieldJwtIss] = struct{}{}
}

// JwtIssCleared returns if the "jwt_iss" field was cleared in this mutation.
func (m *UserMutation) JwtIssCleared() bool {
	_, ok := m.clearedFields[user.FieldJwtIss]
	return ok
}

// ResetJwtIss resets all changes to the "jwt_iss" field.
func (m *UserMutation) ResetJwtIss() {
	m.jwt_iss = nil
	delete(m.clearedFields, user.FieldJwtIss)
}

// SetJwtSub sets the "jwt_sub" field.
func (m *UserMutation) SetJwtSub(s string) {
	m.jwt_sub = &s
}

// JwtSub returns the value of the "jwt_sub" field in the mutation.
func (m *UserMutation) JwtSub() (r string, exists bool) {
	v := m.jwt_sub
	if v == nil {
		return
	}
...
// OldJwtSub returns the old "jwt_sub" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldJwtSub(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldJwtSub is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldJwtSub requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldJwtSub: %w", err)
	}
	return oldValue.JwtSub, nil
}

// ClearJwtSub clears the value of the "jwt_sub" field.
func (m *UserMutation) ClearJwtSub() {
	m.jwt_sub = nil
	m.clearedFields[user.FieldJwtSub] = struct{}{}
}

// JwtSubCleared returns if the "jwt_sub" field was cleared in this mutation.
func (m *UserMutation) JwtSubCleared() bool {
	_, ok := m.clearedFields[user.FieldJwtSub]
	return ok
}

// ResetJwtSub resets all changes to the "jwt_sub" field.
func (m *UserMutation) ResetJwtSub() {
	m.jwt_sub = nil
	delete(m.clearedFields, user.FieldJwtSub)
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.jwt_iss != nil {
		fields = append(fields, user.FieldJwtIss)
	}
	if m.jwt_sub != nil {
		fields = append(fields, user.FieldJwtSub)
	}
	return fields
}
...
func (m *UserMutation) Field(name string) (ent.Value, bool) {
	...
	case user.FieldName:
		return m.Name()
	case user.FieldJwtIss:
		return m.JwtIss()
	case user.FieldJwtSub:
		return m.JwtSub()
	}
	return nil, false
}
...
func (m *UserMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case user.FieldName:
		return m.OldName(ctx)
	case user.FieldJwtIss:
		return m.OldJwtIss(ctx)
	case user.FieldJwtSub:
		return m.OldJwtSub(ctx)
	}
...
func (m *UserMutation) ClearedFields() []string {
	...
	if m.FieldCleared(user.FieldJwtIss) {
		fields = append(fields, user.FieldJwtIss)
	}
	if m.FieldCleared(user.FieldJwtSub) {
		fields = append(fields, user.FieldJwtSub)
	}
	return fields
}
