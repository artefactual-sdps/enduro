...
// OldUploaderID returns the old "uploader_id" field's value of the SIP entity.
// If the SIP object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SIPMutation) OldUploaderID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUploaderID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// UploaderIDCleared returns if the "uploader_id" field was cleared in this mutation.
func (m *SIPMutation) UploaderIDCleared() bool {
	_, ok := m.clearedFields[sip.FieldUploaderID]
	return ok
}
...
func (m *SIPMutation) SetChecksumValue(s string) {
	m.checksum_value = &s
}

// ChecksumValue returns the value of the "checksum_value" field in the mutation.
func (m *SIPMutation) ChecksumValue() (r string, exists bool) {
	v := m.checksum_value
	if v == nil {
		return
	}
...
// OldChecksumValue returns the old "checksum_value" field's value of the SIP entity.
// If the SIP object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SIPMutation) OldChecksumValue(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldChecksumValue is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldChecksumValue requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldChecksumValue: %w", err)
	}
	return oldValue.ChecksumValue, nil
}

// ClearChecksumValue clears the value of the "checksum_value" field.
func (m *SIPMutation) ClearChecksumValue() {
	m.checksum_value = nil
	m.clearedFields[sip.FieldChecksumValue] = struct{}{}
}

// ChecksumValueCleared returns if the "checksum_value" field was cleared in this mutation.
func (m *SIPMutation) ChecksumValueCleared() bool {
	_, ok := m.clearedFields[sip.FieldChecksumValue]
	return ok
}

// ResetChecksumValue resets all changes to the "checksum_value" field.
func (m *SIPMutation) ResetChecksumValue() {
	m.checksum_value = nil
	delete(m.clearedFields, sip.FieldChecksumValue)
}
...
func (m *SIPMutation) Fields() []string {
	...
	if m.checksum_value != nil {
		fields = append(fields, sip.FieldChecksumValue)
	}
	return fields
}
...
func (m *SIPMutation) ClearedFields() []string {
	...
	if m.FieldCleared(sip.FieldChecksumValue) {
		fields = append(fields, sip.FieldChecksumValue)
	}
	return fields
}
...
func (m *UserMutation) SetOidcIss(s string) {
	m.oidc_iss = &s
}

// OidcIss returns the value of the "oidc_iss" field in the mutation.
func (m *UserMutation) OidcIss() (r string, exists bool) {
	v := m.oidc_iss
	if v == nil {
		return
	}
...
// OldOidcIss returns the old "oidc_iss" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldOidcIss(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldOidcIss is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldOidcIss requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldOidcIss: %w", err)
	}
	return oldValue.OidcIss, nil
}

// ClearOidcIss clears the value of the "oidc_iss" field.
func (m *UserMutation) ClearOidcIss() {
	m.oidc_iss = nil
	m.clearedFields[user.FieldOidcIss] = struct{}{}
}

// OidcIssCleared returns if the "oidc_iss" field was cleared in this mutation.
func (m *UserMutation) OidcIssCleared() bool {
	_, ok := m.clearedFields[user.FieldOidcIss]
	return ok
}

// ResetOidcIss resets all changes to the "oidc_iss" field.
func (m *UserMutation) ResetOidcIss() {
	m.oidc_iss = nil
	delete(m.clearedFields, user.FieldOidcIss)
}
...
func (m *UserMutation) AddUploadedSipIDs(ids ...int) {
	if m.uploaded_sips == nil {
		m.uploaded_sips = make(map[int]struct{})
	}
	for i := range ids {
		m.uploaded_sips[ids[i]] = struct{}{}
	}
}

// ClearUploadedSips clears the "uploaded_sips" edge to the SIP entity.
func (m *UserMutation) ClearUploadedSips() {
	m.cleareduploaded_sips = true
}

// UploadedSipsCleared reports if the "uploaded_sips" edge to the SIP entity was cleared.
func (m *UserMutation) UploadedSipsCleared() bool {
	return m.cleareduploaded_sips
}

// RemoveUploadedSipIDs removes the "uploaded_sips" edge to the SIP entity by IDs.
func (m *UserMutation) RemoveUploadedSipIDs(ids ...int) {
	if m.removeduploaded_sips == nil {
		m.removeduploaded_sips = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.uploaded_sips, ids[i])
		m.removeduploaded_sips[ids[i]] = struct{}{}
	}
}

// RemovedUploadedSips returns the removed IDs of the "uploaded_sips" edge to the SIP entity.
func (m *UserMutation) RemovedUploadedSipsIDs() (ids []int) {
	for id := range m.removeduploaded_sips {
		ids = append(ids, id)
	}
	return
}

// UploadedSipsIDs returns the "uploaded_sips" edge IDs in the mutation.
func (m *UserMutation) UploadedSipsIDs() (ids []int) {
	for id := range m.uploaded_sips {
		ids = append(ids, id)
	}
	return
}

// ResetUploadedSips resets all changes to the "uploaded_sips" edge.
func (m *UserMutation) ResetUploadedSips() {
	m.uploaded_sips = nil
	m.cleareduploaded_sips = false
...
func (m *UserMutation) Fields() []string {
	...
	if m.oidc_iss != nil {
		fields = append(fields, user.FieldOidcIss)
	}
	if m.oidc_sub != nil {
...
func (m *UserMutation) ClearedFields() []string {
	...
	if m.FieldCleared(user.FieldOidcIss) {
		fields = append(fields, user.FieldOidcIss)
	}
...
func (m *UserMutation) AddedIDs(name string) []ent.Value {
	...
	case user.EdgeUploadedSips:
		ids := make([]ent.Value, 0, len(m.uploaded_sips))
		for id := range m.uploaded_sips {
			ids = append(ids, id)
		}
		return ids
...
func (m *UserMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case user.EdgeUploadedSips:
		ids := make([]ent.Value, 0, len(m.removeduploaded_sips))
		for id := range m.removeduploaded_sips {
			ids = append(ids, id)
		}
		return ids
