...
var (
	...
	UserColumns = []*schema.Column{
		...
		{Name: "jwt_iss", Type: field.TypeString, Nullable: true, Size: 1024},
		{Name: "jwt_sub", Type: field.TypeString, Nullable: true, Size: 1024},
	}
