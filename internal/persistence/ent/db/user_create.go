...
func (_c *UserCreate) SetOidcIss(v string) *UserCreate {
	_c.mutation.SetOidcIss(v)
	return _c
}

// SetNillableOidcIss sets the "oidc_iss" field if the given value is not nil.
func (_c *UserCreate) SetNillableOidcIss(v *string) *UserCreate {
	if v != nil {
		_c.SetOidcIss(*v)
	}
	return _c
...
func (_c *UserCreate) AddUploadedSipIDs(ids ...int) *UserCreate {
	_c.mutation.AddUploadedSipIDs(ids...)
	return _c
}

// AddUploadedSips adds the "uploaded_sips" edges to the SIP entity.
func (_c *UserCreate) AddUploadedSips(v ...*SIP) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.OidcIss(); ok {
	...
	if nodes := _c.mutation.UploadedSipsIDs(); len(nodes) > 0 {
