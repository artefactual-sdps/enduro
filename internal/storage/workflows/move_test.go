...
func TestStorageMoveWorkflow(t *testing.T) {
	...
	storagesvc.EXPECT().DeleteAip(mockutil.Context(), aipID)
	storagesvc.EXPECT().UpdateAipLocationID(mockutil.Context(), aipID, locationID)
	storagesvc.EXPECT().UpdateAipStatus(mockutil.Context(), aipID, enums.AIPStatusMoving)
	storagesvc.EXPECT().UpdateAipStatus(mockutil.Context(), aipID, enums.AIPStatusStored)
	storagesvc.EXPECT().AIPDBID(mockutil.Context(), aipID).Return(aipDBID, nil)
