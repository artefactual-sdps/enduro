...
func (_q *LocationQuery) QueryAips() *AIPQuery {
...
func (_q *LocationQuery) WithAips(opts ...func(*AIPQuery)) *LocationQuery {
	query := (&AIPClient{config: _q.config}).Query()
...
func (_q *LocationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Location, error) {
	...
	if query := _q.withAips; query != nil {
		if err := _q.loadAips(ctx, query, nodes,
...
func (_q *LocationQuery) loadAips(ctx context.Context, query *AIPQuery, nodes []*Location, init func(*Location), assign func(*Location, *AIP)) error {
