...
func (*DeletionRequest) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case deletionrequest.FieldRequester, deletionrequest.FieldRequesterIss, deletionrequest.FieldRequesterSub, deletionrequest.FieldReviewer, deletionrequest.FieldReviewerIss, deletionrequest.FieldReviewerSub, deletionrequest.FieldReason, deletionrequest.FieldStatus, deletionrequest.FieldDeletionReportKey:
