...
type Service interface {
	...
	ListDeletionRequestsInternal(ctx context.Context, f *persistence.DeletionRequestFilter) ([]*types.DeletionRequest, error)
...
func (svc *serviceImpl) ListDeletionRequestsInternal(ctx context.Context, f *persistence.DeletionRequestFilter) ([]*types.DeletionRequest, error) {
