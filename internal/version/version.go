...
import (
	...
	enduroroot "github.com/artefactual-sdps/enduro"
)
...
func init() {
	...
	if !ok {
		Long = strings.TrimSpace(enduroroot.Version) + "-ERR-BuildInfo"
		Short = Long
		return
	}
	...
	Short = strings.TrimSpace(enduroroot.Version) + "-dev" + commitDate
