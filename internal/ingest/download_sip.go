...
func (w *goaWrapper) checkSIP(ctx context.Context, id string) (*datatypes.SIP, error) {
...
func (w *goaWrapper) DownloadSipRequest(
	...
	if err != nil {
		return nil, goaingest.MakeInternalError(errors.New("failed to request ticket"))
	}

	// Do not set the cookie unless a ticket is provided.
