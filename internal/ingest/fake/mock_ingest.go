...
func (m *MockService) CreateTasks(ctx context.Context, seq persistence.TaskSequence) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTasks", ctx, seq)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateTasks indicates an expected call of CreateTasks.
func (mr *MockServiceMockRecorder) CreateTasks(ctx, seq any) *MockServiceCreateTasksCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTasks", reflect.TypeOf((*MockService)(nil).CreateTasks), ctx, seq)
