...
// EncodeDownloadDeletionReportRequestResponse returns an encoder for responses
// returned by the storage download_deletion_report_request endpoint.
func EncodeDownloadDeletionReportRequestResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*storage.DownloadDeletionReportRequestResult)
		if res.Ticket != nil {
			ticket := *res.Ticket
			http.SetCookie(w, &http.Cookie{
...
// DecodeDownloadDeletionReportRequestRequest returns a decoder for requests
// sent to the storage download_deletion_report_request endpoint.
func DecodeDownloadDeletionReportRequestRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*storage.DownloadDeletionReportRequestPayload, error) {
	return func(r *http.Request) (*storage.DownloadDeletionReportRequestPayload, error) {
		var (
			uuid  string
			token *string
			err   error
		...
		payload := NewDownloadDeletionReportRequestPayload(uuid, token)
		if payload.Token != nil {
			if strings.Contains(*payload.Token, " ") {
				// Remove authorization scheme prefix (e.g. "Bearer")
				cred := strings.SplitN(*payload.Token, " ", 2)[1]
...
// EncodeDownloadDeletionReportRequestError returns an encoder for errors
// returned by the download_deletion_report_request storage endpoint.
func EncodeDownloadDeletionReportRequestError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "not_found":
			...
			if formatter != nil {
				...
				body = NewDownloadDeletionReportRequestNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "not_valid":
			...
			if formatter != nil {
				...
				body = NewDownloadDeletionReportRequestNotValidResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		case "internal_error":
			...
			if formatter != nil {
				...
				body = NewDownloadDeletionReportRequestInternalErrorResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
...
// EncodeDownloadDeletionReportResponse returns an encoder for responses
// returned by the storage download_deletion_report endpoint.
func EncodeDownloadDeletionReportResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*storage.DownloadDeletionReportResult)
		w.Header().Set("Content-Type", res.ContentType)
		{
			val := res.ContentLength
			contentLengths := strconv.FormatInt(val, 10)
...
// DecodeDownloadDeletionReportRequest returns a decoder for requests sent to
// the storage download_deletion_report endpoint.
func DecodeDownloadDeletionReportRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*storage.DownloadDeletionReportPayload, error) {
	return func(r *http.Request) (*storage.DownloadDeletionReportPayload, error) {
		var (
			uuid   string
			ticket *string
			err    error
		...
		payload := NewDownloadDeletionReportPayload(uuid, ticket)

		return payload, nil
	}
}

// EncodeDownloadDeletionReportError returns an encoder for errors returned by
// the download_deletion_report storage endpoint.
func EncodeDownloadDeletionReportError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "not_found":
			...
			if formatter != nil {
				...
				body = NewDownloadDeletionReportNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "not_valid":
			...
			if formatter != nil {
				...
				body = NewDownloadDeletionReportNotValidResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		case "internal_error":
			...
			if formatter != nil {
				...
				body = NewDownloadDeletionReportInternalErrorResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
