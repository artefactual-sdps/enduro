...
type Server struct {
	...
	AipDeletionAuto          http.Handler
	RequestAipDeletion       http.Handler
	ReviewAipDeletion        http.Handler
	CancelAipDeletion        http.Handler
	AipDeletionReportRequest http.Handler
	AipDeletionReport        http.Handler
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"AipDeletionAuto", "POST", "/storage/aips/{uuid}/deletion-auto"},
			...
			{"AipDeletionReportRequest", "POST", "/storage/aips/{uuid}/deletion-report"},
			{"AipDeletionReport", "GET", "/storage/aips/{uuid}/deletion-report"},
			...
			{"CORS", "OPTIONS", "/storage/aips/{uuid}/deletion-auto"},
			...
			{"CORS", "OPTIONS", "/storage/aips/{uuid}/deletion-report"},
		...
		AipDeletionAuto:          NewAipDeletionAutoHandler(e.AipDeletionAuto, mux, decoder, encoder, errhandler, formatter),
		...
		AipDeletionReportRequest: NewAipDeletionReportRequestHandler(e.AipDeletionReportRequest, mux, decoder, encoder, errhandler, formatter),
		AipDeletionReport:        NewAipDeletionReportHandler(e.AipDeletionReport, mux, decoder, encoder, errhandler, formatter),
...
func (s *Server) Use(m func(http.Handler) http.Handler) {
	...
	s.AipDeletionAuto = m(s.AipDeletionAuto)
	...
	s.AipDeletionReportRequest = m(s.AipDeletionReportRequest)
	s.AipDeletionReport = m(s.AipDeletionReport)
...
func Mount(mux goahttp.Muxer, h *Server) {
	...
	MountAipDeletionAutoHandler(mux, h.AipDeletionAuto)
	...
	MountAipDeletionReportRequestHandler(mux, h.AipDeletionReportRequest)
	MountAipDeletionReportHandler(mux, h.AipDeletionReport)
...
func MountSubmitAipCompleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/storage/aips/{uuid}/submit-complete", otelhttp.WithRouteTag("/storage/aips/{uuid}/submit-complete", f).ServeHTTP)
}
...
// MountAipDeletionAutoHandler configures the mux to serve the "storage"
// service "aip_deletion_auto" endpoint.
func MountAipDeletionAutoHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := HandleStorageOrigin(h).(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/storage/aips/{uuid}/deletion-auto", otelhttp.WithRouteTag("/storage/aips/{uuid}/deletion-auto", f).ServeHTTP)
}

// NewAipDeletionAutoHandler creates a HTTP handler which loads the HTTP
// request and calls the "storage" service "aip_deletion_auto" endpoint.
func NewAipDeletionAutoHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeAipDeletionAutoRequest(mux, decoder)
		encodeResponse = EncodeAipDeletionAutoResponse(encoder)
		encodeError    = EncodeAipDeletionAutoError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "aip_deletion_auto")
		ctx = context.WithValue(ctx, goa.ServiceKey, "storage")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
...
// MountAipDeletionReportRequestHandler configures the mux to serve the
// "storage" service "aip_deletion_report_request" endpoint.
func MountAipDeletionReportRequestHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := HandleStorageOrigin(h).(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/storage/aips/{uuid}/deletion-report", otelhttp.WithRouteTag("/storage/aips/{uuid}/deletion-report", f).ServeHTTP)
}

// NewAipDeletionReportRequestHandler creates a HTTP handler which loads the
// HTTP request and calls the "storage" service "aip_deletion_report_request"
// endpoint.
func NewAipDeletionReportRequestHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeAipDeletionReportRequestRequest(mux, decoder)
		encodeResponse = EncodeAipDeletionReportRequestResponse(encoder)
		encodeError    = EncodeAipDeletionReportRequestError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "aip_deletion_report_request")
		ctx = context.WithValue(ctx, goa.ServiceKey, "storage")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
...
// MountAipDeletionReportHandler configures the mux to serve the "storage"
// service "aip_deletion_report" endpoint.
func MountAipDeletionReportHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := HandleStorageOrigin(h).(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("GET", "/storage/aips/{uuid}/deletion-report", otelhttp.WithRouteTag("/storage/aips/{uuid}/deletion-report", f).ServeHTTP)
}

// NewAipDeletionReportHandler creates a HTTP handler which loads the HTTP
// request and calls the "storage" service "aip_deletion_report" endpoint.
func NewAipDeletionReportHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeAipDeletionReportRequest(mux, decoder)
		encodeResponse = EncodeAipDeletionReportResponse(encoder)
		encodeError    = EncodeAipDeletionReportError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "aip_deletion_report")
		ctx = context.WithValue(ctx, goa.ServiceKey, "storage")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
		...
		o := res.(*storage.AipDeletionReportResponseData)
		defer o.Body.Close()
		if wt, ok := o.Body.(io.WriterTo); ok {
			if err := encodeResponse(ctx, w, o.Result); err != nil {
				if errhandler != nil {
...
func MountCORSHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("OPTIONS", "/storage/aips/{uuid}/deletion-auto", h.ServeHTTP)
	...
	mux.Handle("OPTIONS", "/storage/aips/{uuid}/deletion-report", h.ServeHTTP)
