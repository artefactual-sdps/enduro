...
// Send Send streams instances of "storage.StorageEvent" to the "monitor"
// endpoint SSE connection.
func (s *MonitorServerStream) Send(v *storage.StorageEvent) error {
	return s.SendWithContext(context.Background(), v)
}

// SendWithContext SendWithContext streams instances of "storage.StorageEvent"
// to the "monitor" endpoint SSE connection with context.
