...
//
// storage WebSocket server streaming
//
// Command:
...
// MonitorServerStream implements the storage.MonitorServerStream interface.
...
// SendWithContext streams instances of "storage.StorageEvent" to the "monitor"
// endpoint websocket connection with context.
func (s *MonitorServerStream) SendWithContext(ctx context.Context, v *storage.StorageEvent) error {
	return s.Send(v)
}
