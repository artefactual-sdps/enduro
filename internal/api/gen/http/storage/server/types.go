...
func NewDownloadDeletionReportRequestPayload(key string, token *string) *storage.DownloadDeletionReportRequestPayload {
...
func NewDownloadDeletionReportPayload(key string, ticket *string) *storage.DownloadDeletionReportPayload {
