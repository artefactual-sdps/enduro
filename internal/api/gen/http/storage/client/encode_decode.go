...
// BuildAipDeletionReportRequestRequest instantiates a HTTP request object with
// method and path set to call the "storage" service
// "aip_deletion_report_request" endpoint
func (c *Client) BuildAipDeletionReportRequestRequest(ctx context.Context, v any) (*http.Request, error) {
	var (
		uuid string
	)
	{
		p, ok := v.(*storage.AipDeletionReportRequestPayload)
		if !ok {
			return nil, goahttp.ErrInvalidType("storage", "aip_deletion_report_request", "*storage.AipDeletionReportRequestPayload", v)
		}
		uuid = p.UUID
	}
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: AipDeletionReportRequestStoragePath(uuid)}
	req, err := http.NewRequest("POST", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("storage", "aip_deletion_report_request", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeAipDeletionReportRequestRequest returns an encoder for requests sent
// to the storage aip_deletion_report_request server.
func EncodeAipDeletionReportRequestRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*storage.AipDeletionReportRequestPayload)
		if !ok {
			return goahttp.ErrInvalidType("storage", "aip_deletion_report_request", "*storage.AipDeletionReportRequestPayload", v)
		}
		if p.Token != nil {
			head := *p.Token
			if !strings.Contains(head, " ") {
...
// DecodeAipDeletionReportRequestResponse returns a decoder for responses
// returned by the storage aip_deletion_report_request endpoint. restoreBody
// controls whether the response body should be restored after having been read.
// DecodeAipDeletionReportRequestResponse may return the following errors:
...
//   - "unauthorized" (type storage.Unauthorized): http.StatusUnauthorized
//   - error: internal error
func DecodeAipDeletionReportRequestResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusOK:
			...
			res := NewAipDeletionReportRequestResultOK(ticket)
			return res, nil
		case http.StatusNotFound:
			var (
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("storage", "aip_deletion_report_request", err)
			}
			err = ValidateAipDeletionReportRequestNotFoundResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("storage", "aip_deletion_report_request", err)
			}
			return nil, NewAipDeletionReportRequestNotFound(&body)
		case http.StatusBadRequest:
			var (
			...
			err = ValidateAipDeletionReportRequestNotValidResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("storage", "aip_deletion_report_request", err)
			}
			return nil, NewAipDeletionReportRequestNotValid(&body)
		case http.StatusInternalServerError:
			var (
			...
			err = ValidateAipDeletionReportRequestInternalErrorResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("storage", "aip_deletion_report_request", err)
			}
			return nil, NewAipDeletionReportRequestInternalError(&body)
		case http.StatusForbidden:
			var (
				body string
				err  error
			...
			return nil, NewAipDeletionReportRequestForbidden(body)
		case http.StatusUnauthorized:
			var (
				body string
				err  error
			...
			return nil, NewAipDeletionReportRequestUnauthorized(body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("storage", "aip_deletion_report_request", resp.StatusCode, string(body))
		}
	}
}

// BuildAipDeletionReportRequest instantiates a HTTP request object with method
// and path set to call the "storage" service "aip_deletion_report" endpoint
func (c *Client) BuildAipDeletionReportRequest(ctx context.Context, v any) (*http.Request, error) {
	var (
		uuid string
	)
	{
		p, ok := v.(*storage.AipDeletionReportPayload)
		if !ok {
			return nil, goahttp.ErrInvalidType("storage", "aip_deletion_report", "*storage.AipDeletionReportPayload", v)
		}
		uuid = p.UUID
	}
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: AipDeletionReportStoragePath(uuid)}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("storage", "aip_deletion_report", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeAipDeletionReportRequest returns an encoder for requests sent to the
// storage aip_deletion_report server.
func EncodeAipDeletionReportRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*storage.AipDeletionReportPayload)
		if !ok {
			return goahttp.ErrInvalidType("storage", "aip_deletion_report", "*storage.AipDeletionReportPayload", v)
		}
		if p.Ticket != nil {
			v := *p.Ticket
			req.AddCookie(&http.Cookie{
...
// DecodeAipDeletionReportResponse returns a decoder for responses returned by
// the storage aip_deletion_report endpoint. restoreBody controls whether the
// response body should be restored after having been read.
// DecodeAipDeletionReportResponse may return the following errors:
//   - "not_found" (type *goa.ServiceError): http.StatusNotFound
//   - "not_valid" (type *goa.ServiceError): http.StatusBadRequest
//   - "internal_error" (type *goa.ServiceError): http.StatusInternalServerError
//   - "forbidden" (type storage.Forbidden): http.StatusForbidden
//   - "unauthorized" (type storage.Unauthorized): http.StatusUnauthorized
//   - error: internal error
func DecodeAipDeletionReportResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusOK:
			...
			contentType = contentTypeRaw
			{
				contentLengthRaw := resp.Header.Get("Content-Length")
				if contentLengthRaw == "" {
					return nil, goahttp.ErrValidationError("storage", "aip_deletion_report", goa.MissingFieldError("content_length", "header"))
				}
				v, err2 := strconv.ParseInt(contentLengthRaw, 10, 64)
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("content_length", contentLengthRaw, "integer"))
			...
			contentDisposition = contentDispositionRaw
			if err != nil {
				return nil, goahttp.ErrValidationError("storage", "aip_deletion_report", err)
			}
			res := NewAipDeletionReportResultOK(contentType, contentLength, contentDisposition)
			return res, nil
		case http.StatusNotFound:
			var (
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("storage", "aip_deletion_report", err)
			}
			err = ValidateAipDeletionReportNotFoundResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("storage", "aip_deletion_report", err)
			}
			return nil, NewAipDeletionReportNotFound(&body)
		case http.StatusBadRequest:
			var (
			...
			err = ValidateAipDeletionReportNotValidResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("storage", "aip_deletion_report", err)
			}
			return nil, NewAipDeletionReportNotValid(&body)
		case http.StatusInternalServerError:
			var (
			...
			err = ValidateAipDeletionReportInternalErrorResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("storage", "aip_deletion_report", err)
			}
			return nil, NewAipDeletionReportInternalError(&body)
		case http.StatusForbidden:
			var (
				body string
				err  error
			...
			return nil, NewAipDeletionReportForbidden(body)
		case http.StatusUnauthorized:
			var (
				body string
				err  error
			...
			return nil, NewAipDeletionReportUnauthorized(body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("storage", "aip_deletion_report", resp.StatusCode, string(body))
		}
	}
}
...
func DecodeListLocationsResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			var (
				body LocationResponseCollection
				err  error
			)
			err = decoder(resp).Decode(&body)
			if err != nil {
...
// unmarshalStoragePingEventResponseBodyToStorageStoragePingEvent builds a
// value of type *storage.StoragePingEvent from a value of type
// *StoragePingEventResponseBody.
func unmarshalStoragePingEventResponseBodyToStorageStoragePingEvent(v *StoragePingEventResponseBody) *storage.StoragePingEvent {
	if v == nil {
		return nil
	}
	res := &storage.StoragePingEvent{
		Message: v.Message,
	}
...
// unmarshalLocationCreatedEventResponseBodyToStorageLocationCreatedEvent
// builds a value of type *storage.LocationCreatedEvent from a value of type
// *LocationCreatedEventResponseBody.
func unmarshalLocationCreatedEventResponseBodyToStorageLocationCreatedEvent(v *LocationCreatedEventResponseBody) *storage.LocationCreatedEvent {
	if v == nil {
		return nil
	}
	res := &storage.LocationCreatedEvent{
		UUID: *v.UUID,
	}
	res.Item = unmarshalLocationResponseBodyToStorageLocation(v.Item)

	return res
}

// unmarshalLocationResponseBodyToStorageLocation builds a value of type
// *storage.Location from a value of type *LocationResponseBody.
func unmarshalLocationResponseBodyToStorageLocation(v *LocationResponseBody) *storage.Location {
	res := &storage.Location{
		Name:        *v.Name,
	...
	if v.Config.Kind() != "" {
		...
		case "amss":
			...
			obj := unmarshalAMSSConfigResponseBodyToStorageAMSSConfig(actual)
			u := res.Config
			u.SetAmss((*storage.AMSSConfig)(obj))
			res.Config = u
		case "s3":
			actual, _ := v.Config.AsS3()
			obj := unmarshalS3ConfigResponseBodyToStorageS3Config(actual)
			u := res.Config
			u.SetS3((*storage.S3Config)(obj))
			res.Config = u
		case "sftp":
			actual, _ := v.Config.AsSftp()
			obj := unmarshalSFTPConfigResponseBodyToStorageSFTPConfig(actual)
			u := res.Config
			u.SetSftp((*storage.SFTPConfig)(obj))
			res.Config = u
		case "url":
			actual, _ := v.Config.AsURL()
			obj := unmarshalURLConfigResponseBodyToStorageURLConfig(actual)
			u := res.Config
...
// unmarshalAMSSConfigResponseBodyToStorageAMSSConfig builds a value of type
// *storage.AMSSConfig from a value of type *AMSSConfigResponseBody.
func unmarshalAMSSConfigResponseBodyToStorageAMSSConfig(v *AMSSConfigResponseBody) *storage.AMSSConfig {
	if v == nil {
		return nil
	}
...
// unmarshalS3ConfigResponseBodyToStorageS3Config builds a value of type
// *storage.S3Config from a value of type *S3ConfigResponseBody.
func unmarshalS3ConfigResponseBodyToStorageS3Config(v *S3ConfigResponseBody) *storage.S3Config {
	if v == nil {
		return nil
	}
...
// unmarshalSFTPConfigResponseBodyToStorageSFTPConfig builds a value of type
// *storage.SFTPConfig from a value of type *SFTPConfigResponseBody.
func unmarshalSFTPConfigResponseBodyToStorageSFTPConfig(v *SFTPConfigResponseBody) *storage.SFTPConfig {
	if v == nil {
		return nil
	}
...
// unmarshalURLConfigResponseBodyToStorageURLConfig builds a value of type
// *storage.URLConfig from a value of type *URLConfigResponseBody.
func unmarshalURLConfigResponseBodyToStorageURLConfig(v *URLConfigResponseBody) *storage.URLConfig {
	if v == nil {
		return nil
	}
...
// unmarshalAIPCreatedEventResponseBodyToStorageAIPCreatedEvent builds a value
// of type *storage.AIPCreatedEvent from a value of type
// *AIPCreatedEventResponseBody.
func unmarshalAIPCreatedEventResponseBodyToStorageAIPCreatedEvent(v *AIPCreatedEventResponseBody) *storage.AIPCreatedEvent {
	if v == nil {
		return nil
	}
	res := &storage.AIPCreatedEvent{
		UUID: *v.UUID,
	}
	res.Item = unmarshalAIPResponseBodyToStorageAIP(v.Item)

	return res
}

// unmarshalAIPResponseBodyToStorageAIP builds a value of type *storage.AIP
// from a value of type *AIPResponseBody.
func unmarshalAIPResponseBodyToStorageAIP(v *AIPResponseBody) *storage.AIP {
	res := &storage.AIP{
		Name:              *v.Name,
		UUID:              *v.UUID,
		Status:            *v.Status,
...
// unmarshalAIPUpdatedEventResponseBodyToStorageAIPUpdatedEvent builds a value
// of type *storage.AIPUpdatedEvent from a value of type
// *AIPUpdatedEventResponseBody.
func unmarshalAIPUpdatedEventResponseBodyToStorageAIPUpdatedEvent(v *AIPUpdatedEventResponseBody) *storage.AIPUpdatedEvent {
	if v == nil {
		return nil
	}
	res := &storage.AIPUpdatedEvent{
		UUID: *v.UUID,
	}
	res.Item = unmarshalAIPResponseBodyToStorageAIP(v.Item)
...
// unmarshalAIPStatusUpdatedEventResponseBodyToStorageAIPStatusUpdatedEvent
// builds a value of type *storage.AIPStatusUpdatedEvent from a value of type
// *AIPStatusUpdatedEventResponseBody.
func unmarshalAIPStatusUpdatedEventResponseBodyToStorageAIPStatusUpdatedEvent(v *AIPStatusUpdatedEventResponseBody) *storage.AIPStatusUpdatedEvent {
	if v == nil {
		return nil
	}
	res := &storage.AIPStatusUpdatedEvent{
		UUID:   *v.UUID,
		Status: *v.Status,
	}
...
// unmarshalAIPLocationUpdatedEventResponseBodyToStorageAIPLocationUpdatedEvent
// builds a value of type *storage.AIPLocationUpdatedEvent from a value of type
// *AIPLocationUpdatedEventResponseBody.
func unmarshalAIPLocationUpdatedEventResponseBodyToStorageAIPLocationUpdatedEvent(v *AIPLocationUpdatedEventResponseBody) *storage.AIPLocationUpdatedEvent {
	if v == nil {
		return nil
	}
	res := &storage.AIPLocationUpdatedEvent{
		UUID:         *v.UUID,
		LocationUUID: *v.LocationUUID,
	}
...
// unmarshalAIPWorkflowCreatedEventResponseBodyToStorageAIPWorkflowCreatedEvent
// builds a value of type *storage.AIPWorkflowCreatedEvent from a value of type
// *AIPWorkflowCreatedEventResponseBody.
func unmarshalAIPWorkflowCreatedEventResponseBodyToStorageAIPWorkflowCreatedEvent(v *AIPWorkflowCreatedEventResponseBody) *storage.AIPWorkflowCreatedEvent {
	if v == nil {
		return nil
	}
	res := &storage.AIPWorkflowCreatedEvent{
		UUID: *v.UUID,
	}
	res.Item = unmarshalAIPWorkflowResponseBodyToStorageAIPWorkflow(v.Item)

	return res
}

// unmarshalAIPWorkflowResponseBodyToStorageAIPWorkflow builds a value of type
// *storage.AIPWorkflow from a value of type *AIPWorkflowResponseBody.
func unmarshalAIPWorkflowResponseBodyToStorageAIPWorkflow(v *AIPWorkflowResponseBody) *storage.AIPWorkflow {
	res := &storage.AIPWorkflow{
		UUID:        *v.UUID,
	...
	if v.Tasks != nil {
		res.Tasks = make([]*storage.AIPTask, len(v.Tasks))
		for i, val := range v.Tasks {
			if val == nil {
				res.Tasks[i] = nil
				continue
			}
			res.Tasks[i] = unmarshalAIPTaskResponseBodyToStorageAIPTask(val)
		}
	}
...
// unmarshalAIPTaskResponseBodyToStorageAIPTask builds a value of type
// *storage.AIPTask from a value of type *AIPTaskResponseBody.
func unmarshalAIPTaskResponseBodyToStorageAIPTask(v *AIPTaskResponseBody) *storage.AIPTask {
	if v == nil {
		return nil
	}
	res := &storage.AIPTask{
...
// unmarshalAIPWorkflowUpdatedEventResponseBodyToStorageAIPWorkflowUpdatedEvent
// builds a value of type *storage.AIPWorkflowUpdatedEvent from a value of type
// *AIPWorkflowUpdatedEventResponseBody.
func unmarshalAIPWorkflowUpdatedEventResponseBodyToStorageAIPWorkflowUpdatedEvent(v *AIPWorkflowUpdatedEventResponseBody) *storage.AIPWorkflowUpdatedEvent {
	if v == nil {
		return nil
	}
	res := &storage.AIPWorkflowUpdatedEvent{
		UUID: *v.UUID,
	}
	res.Item = unmarshalAIPWorkflowResponseBodyToStorageAIPWorkflow(v.Item)
...
// unmarshalAIPTaskCreatedEventResponseBodyToStorageAIPTaskCreatedEvent builds
// a value of type *storage.AIPTaskCreatedEvent from a value of type
// *AIPTaskCreatedEventResponseBody.
func unmarshalAIPTaskCreatedEventResponseBodyToStorageAIPTaskCreatedEvent(v *AIPTaskCreatedEventResponseBody) *storage.AIPTaskCreatedEvent {
	if v == nil {
		return nil
	}
	res := &storage.AIPTaskCreatedEvent{
		UUID: *v.UUID,
	}
	res.Item = unmarshalAIPTaskResponseBodyToStorageAIPTask(v.Item)

	return res
}

// unmarshalAIPTaskUpdatedEventResponseBodyToStorageAIPTaskUpdatedEvent builds
// a value of type *storage.AIPTaskUpdatedEvent from a value of type
// *AIPTaskUpdatedEventResponseBody.
func unmarshalAIPTaskUpdatedEventResponseBodyToStorageAIPTaskUpdatedEvent(v *AIPTaskUpdatedEventResponseBody) *storage.AIPTaskUpdatedEvent {
	if v == nil {
		return nil
	}
	res := &storage.AIPTaskUpdatedEvent{
		UUID: *v.UUID,
	}
	res.Item = unmarshalAIPTaskResponseBodyToStorageAIPTask(v.Item)
...
// marshalStorageAMSSConfigToAMSSConfigRequestBody builds a value of type
// *AMSSConfigRequestBody from a value of type *storage.AMSSConfig.
func marshalStorageAMSSConfigToAMSSConfigRequestBody(v *storage.AMSSConfig) *AMSSConfigRequestBody {
	if v == nil {
		return nil
	}
	res := &AMSSConfigRequestBody{
		APIKey:   v.APIKey,
		URL:      v.URL,
		Username: v.Username,
	}
...
// marshalStorageS3ConfigToS3ConfigRequestBody builds a value of type
// *S3ConfigRequestBody from a value of type *storage.S3Config.
func marshalStorageS3ConfigToS3ConfigRequestBody(v *storage.S3Config) *S3ConfigRequestBody {
	if v == nil {
		return nil
	}
	res := &S3ConfigRequestBody{
		Bucket:    v.Bucket,
		Region:    v.Region,
		Endpoint:  v.Endpoint,
		PathStyle: v.PathStyle,
...
// marshalStorageSFTPConfigToSFTPConfigRequestBody builds a value of type
// *SFTPConfigRequestBody from a value of type *storage.SFTPConfig.
func marshalStorageSFTPConfigToSFTPConfigRequestBody(v *storage.SFTPConfig) *SFTPConfigRequestBody {
	if v == nil {
		return nil
	}
	res := &SFTPConfigRequestBody{
		Address:   v.Address,
		Username:  v.Username,
		Password:  v.Password,
		Directory: v.Directory,
...
// marshalStorageURLConfigToURLConfigRequestBody builds a value of type
// *URLConfigRequestBody from a value of type *storage.URLConfig.
func marshalStorageURLConfigToURLConfigRequestBody(v *storage.URLConfig) *URLConfigRequestBody {
	if v == nil {
		return nil
	}
	res := &URLConfigRequestBody{
		URL: v.URL,
	}
...
// marshalAMSSConfigRequestBodyToStorageAMSSConfig builds a value of type
// *storage.AMSSConfig from a value of type *AMSSConfigRequestBody.
func marshalAMSSConfigRequestBodyToStorageAMSSConfig(v *AMSSConfigRequestBody) *storage.AMSSConfig {
	if v == nil {
		return nil
	}
	res := &storage.AMSSConfig{
...
// marshalS3ConfigRequestBodyToStorageS3Config builds a value of type
// *storage.S3Config from a value of type *S3ConfigRequestBody.
func marshalS3ConfigRequestBodyToStorageS3Config(v *S3ConfigRequestBody) *storage.S3Config {
	if v == nil {
		return nil
	}
	res := &storage.S3Config{
...
// marshalSFTPConfigRequestBodyToStorageSFTPConfig builds a value of type
// *storage.SFTPConfig from a value of type *SFTPConfigRequestBody.
func marshalSFTPConfigRequestBodyToStorageSFTPConfig(v *SFTPConfigRequestBody) *storage.SFTPConfig {
	if v == nil {
		return nil
	}
	res := &storage.SFTPConfig{
...
// marshalURLConfigRequestBodyToStorageURLConfig builds a value of type
// *storage.URLConfig from a value of type *URLConfigRequestBody.
func marshalURLConfigRequestBodyToStorageURLConfig(v *URLConfigRequestBody) *storage.URLConfig {
	if v == nil {
		return nil
	}
	res := &storage.URLConfig{
