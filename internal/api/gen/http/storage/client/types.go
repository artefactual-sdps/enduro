...
type CancelAipDeletionRequestBody struct {
	// If test is true user authorization to cancel deletion is checked but the
	// request is not cancelled.
	Test *bool `form:"test,omitempty" json:"test,omitempty" xml:"test,omitempty"`
}
...
// NewListAipWorkflowsRequestBody builds the HTTP request body from the payload
