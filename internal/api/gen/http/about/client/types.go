...
// ValidateEnduroChildworkflowResponseBodyCollection runs the validations
// defined on EnduroChildworkflowResponseBodyCollection
func ValidateEnduroChildworkflowResponseBodyCollection(body EnduroChildworkflowResponseBodyCollection) (err error) {
	for _, e := range body {
		if e != nil {
