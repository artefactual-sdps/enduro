...
// MonitorServerStream implements the ingest.MonitorServerStream interface
...
// Send Send streams instances of "ingest.IngestEvent" to the "monitor"
// endpoint SSE connection.
func (s *MonitorServerStream) Send(v *ingest.IngestEvent) error {
	return s.SendWithContext(context.Background(), v)
}

// SendWithContext SendWithContext streams instances of "ingest.IngestEvent" to
// the "monitor" endpoint SSE connection with context.
func (s *MonitorServerStream) SendWithContext(ctx context.Context, v *ingest.IngestEvent) error {
	s.once.Do(func() {
		header := s.w.Header()
