...
//
// ingest WebSocket server streaming
//
// Command:
...
// Send streams instances of "ingest.IngestEvent" to the "monitor" endpoint
...
// SendWithContext streams instances of "ingest.IngestEvent" to the "monitor"
