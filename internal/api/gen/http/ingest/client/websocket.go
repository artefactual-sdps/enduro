...
// Recv reads instances of "ingest.IngestMonitorEvent" from the "monitor"
// endpoint websocket connection.
func (s *MonitorClientStream) Recv() (*ingest.IngestMonitorEvent, error) {
	var (
		rv   *ingest.IngestMonitorEvent
