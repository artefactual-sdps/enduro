...
// RecvWithContext reads instances of "ingest.IngestEvent" from the "monitor"
// endpoint websocket connection with context.
func (s *MonitorClientStream) RecvWithContext(ctx context.Context) (*ingest.IngestEvent, error) {
	return s.Recv()
}
