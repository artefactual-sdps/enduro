...
// Send streams instances of "package_.EnduroMonitorUpdate" to the "monitor"
// endpoint websocket connection.
func (s *MonitorServerStream) Send(v *package_.EnduroMonitorUpdate) error {
	var err error
	...
	res := package_.NewViewedEnduroMonitorUpdate(v, "default")
