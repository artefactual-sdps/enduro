...
func UsageExamples() string {
	return os.Args[0] + ` batch submit --body '{
      ...
      "name": "Ipsa ut."
   }' --aip-id "Voluptatum labore et voluptatem quia."` + "\n" +
		""
}
...
Example:
    %[1]s package list --name "Aut impedit." --aip-id "0C589E55-99C1-3ED8-809A-1463C91242B6" --earliest-created-time "1973-08-04T01:33:26Z" --latest-created-time "2008-05-29T00:39:53Z" --location "Velit accusantium aut voluptatem qui quibusdam." --status "abandoned" --cursor "Labore sit occaecati quia aliquid labore quibusdam."
`, os.Args[0])
}
...
Example:
    %[1]s package show --id 11492148683240979831
`, os.Args[0])
}
...
Example:
    %[1]s package delete --id 13291142877433500278
`, os.Args[0])
}
...
Example:
    %[1]s package cancel --id 9920045945782004348
`, os.Args[0])
}
...
Example:
    %[1]s package retry --id 8405518800464609225
`, os.Args[0])
}
...
Example:
    %[1]s package workflow --id 10085348636241358776
`, os.Args[0])
}
...
Example:
    %[1]s package preservation-actions --id 7792703532795928158
`, os.Args[0])
}
...
Example:
    %[1]s package confirm --body '{
      "location": "Voluptas doloribus."
   }' --id 11214822192742211636
`, os.Args[0])
}
...
Example:
    %[1]s package reject --id 17611053829037806340
`, os.Args[0])
}
...
Example:
    %[1]s package move --body '{
      "location": "Cupiditate vel molestiae."
   }' --id 7982077703646575391
`, os.Args[0])
}
...
Example:
    %[1]s package move-status --id 2846484845428550035
`, os.Args[0])
}
...
Example:
    %[1]s storage update --aip-id "Accusantium sed dolores occaecati aut."
`, os.Args[0])
}
...
Example:
    %[1]s storage download --aip-id "Ut ipsam fugiat."
`, os.Args[0])
}
...
Example:
    %[1]s storage move --body '{
      "location": "Repudiandae optio accusamus dolor minus."
   }' --aip-id "Sed omnis doloremque sint dolorum quasi."
`, os.Args[0])
}
...
Example:
    %[1]s storage move-status --aip-id "Magnam tempore et qui."
`, os.Args[0])
}
...
Example:
    %[1]s storage reject --aip-id "Voluptate et incidunt laboriosam mollitia recusandae."
`, os.Args[0])
}
...
Example:
    %[1]s storage show --aip-id "Molestiae omnis dolorem."
`, os.Args[0])
}
