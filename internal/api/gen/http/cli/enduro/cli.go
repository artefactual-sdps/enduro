...
func UsageExamples() string {
	return os.Args[0] + ` package monitor-request --oauth-token "Sequi magnam ea et."` + "\n" +
      ...
      "name": "Aperiam velit."
   }' --aip-id "96F4610B-3915-E458-BE96-D8CF9D260286" --oauth-token "Eligendi et."` + "\n" +
		os.Args[0] + ` upload upload --content-type "multipart/񌇣򃵘𔨳𯶁; boundary=���" --oauth-token "Ea facilis laboriosam odio veritatis laborum." --stream "goa.png"` + "\n" +
		""
}
...
Example:
    %[1]s package list --name "Praesentium commodi voluptas doloribus." --aip-id "53946C46-F107-29BF-034F-35FFE53795AE" --earliest-created-time "2014-12-03T22:37:50Z" --latest-created-time "1997-09-03T04:44:31Z" --location-id "9F86A8D2-3127-0F16-A741-B4D398285DF4" --status "pending" --cursor "Dolorem cum optio non." --oauth-token "Officia sint et quae quisquam soluta."
`, os.Args[0])
}
...
Example:
    %[1]s storage update --aip-id "55931FDF-8B7A-94AF-ABF5-B7CCECF5FB97" --oauth-token "Beatae assumenda esse consequatur reiciendis ratione nam."
`, os.Args[0])
}
...
Example:
    %[1]s storage download --aip-id "51F9EE5F-C888-BF3D-CE3E-765E2C718C1E" --oauth-token "Similique ab error voluptas sint voluptatibus quo."
`, os.Args[0])
}
...
Example:
   ...
   }' --aip-id "47936A41-8C1D-8CF2-D6DC-C08388794599" --oauth-token "Nobis nostrum aut iusto fugit sunt."
`, os.Args[0])
}
...
Example:
    %[1]s storage move-status --aip-id "0C73FA0E-DA2F-FFD2-93EC-6054BA8F9B27" --oauth-token "Omnis aspernatur sunt illo facilis."
`, os.Args[0])
}
...
Example:
    %[1]s storage reject --aip-id "38B20855-D674-2CDE-A0E0-AA67251B4F96" --oauth-token "Ut perspiciatis quis provident adipisci reprehenderit accusamus."
`, os.Args[0])
}
...
Example:
    %[1]s storage show --aip-id "BE661E0C-5AD9-ED15-BEDC-4CC95C767659" --oauth-token "Quo odit qui numquam totam."
`, os.Args[0])
}
...
Example:
    %[1]s storage show-location --uuid "BB9F625E-3447-708D-F5C0-7952A1E415AE" --oauth-token "Ut fugit cum consequatur non eos consequuntur."
`, os.Args[0])
}
...
Example:
    %[1]s storage location-packages --uuid "DF996131-B973-12F6-641E-A61667D3568C" --oauth-token "Nostrum possimus fugiat beatae."
`, os.Args[0])
}
...
Example:
    %[1]s upload upload --content-type "multipart/񌇣򃵘𔨳𯶁; boundary=���" --oauth-token "Ea facilis laboriosam odio veritatis laborum." --stream "goa.png"
`, os.Args[0])
}
