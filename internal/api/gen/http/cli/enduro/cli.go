...
func UsageExamples() string {
	return os.Args[0] + ` package monitor-request --oauth-token "Sequi magnam ea et."` + "\n" +
      ...
      "name": "Aperiam velit."
   }' --aip-id "fe8a43ea-04c9-11ee-9394-9cb6d0ba4ddb" --oauth-token "Eligendi et."` + "\n" +
		os.Args[0] + ` upload upload --content-type "multipart/򵕇; boundary=����" --oauth-token "Ea facilis laboriosam odio veritatis laborum." --stream "goa.png"` + "\n" +
		""
}
...
Example:
    %[1]s package list --name "Praesentium commodi voluptas doloribus." --aip-id "fe88a947-04c9-11ee-9394-9cb6d0ba4ddb" --earliest-created-time "2014-12-03T22:37:50Z" --latest-created-time "1997-09-03T04:44:31Z" --location-id "fe88b240-04c9-11ee-9394-9cb6d0ba4ddb" --status "pending" --cursor "Dolorem cum optio non." --oauth-token "Officia sint et quae quisquam soluta."
`, os.Args[0])
}
...
Example:
    %[1]s storage update --aip-id "fe8a630e-04c9-11ee-9394-9cb6d0ba4ddb" --oauth-token "Beatae assumenda esse consequatur reiciendis ratione nam."
`, os.Args[0])
}
...
Example:
    %[1]s storage download --aip-id "fe8a8c57-04c9-11ee-9394-9cb6d0ba4ddb" --oauth-token "Similique ab error voluptas sint voluptatibus quo."
`, os.Args[0])
}
...
Example:
   ...
   }' --aip-id "fe8adbd1-04c9-11ee-9394-9cb6d0ba4ddb" --oauth-token "Nobis nostrum aut iusto fugit sunt."
`, os.Args[0])
}
...
Example:
    %[1]s storage move-status --aip-id "fe8afdae-04c9-11ee-9394-9cb6d0ba4ddb" --oauth-token "Omnis aspernatur sunt illo facilis."
`, os.Args[0])
}
...
Example:
    %[1]s storage reject --aip-id "fe8b1bb2-04c9-11ee-9394-9cb6d0ba4ddb" --oauth-token "Ut perspiciatis quis provident adipisci reprehenderit accusamus."
`, os.Args[0])
}
...
Example:
    %[1]s storage show --aip-id "fe8b3ac3-04c9-11ee-9394-9cb6d0ba4ddb" --oauth-token "Quo odit qui numquam totam."
`, os.Args[0])
}
...
Example:
    %[1]s storage show-location --uuid "fe8b5ea8-04c9-11ee-9394-9cb6d0ba4ddb" --oauth-token "Ut fugit cum consequatur non eos consequuntur."
`, os.Args[0])
}
...
Example:
    %[1]s storage location-packages --uuid "fe8b7feb-04c9-11ee-9394-9cb6d0ba4ddb" --oauth-token "Nostrum possimus fugiat beatae."
`, os.Args[0])
}
...
Example:
    %[1]s upload upload --content-type "multipart/򵕇; boundary=����" --oauth-token "Ea facilis laboriosam odio veritatis laborum." --stream "goa.png"
`, os.Args[0])
}
