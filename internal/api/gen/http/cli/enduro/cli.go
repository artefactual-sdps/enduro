...
func ParseEndpoint(
	...
	var (
		...
		ingestListSourceItemsBodyFlag  = ingestListSourceItemsFlags.String("body", "REQUIRED", "")
		ingestListSourceItemsUUIDFlag  = ingestListSourceItemsFlags.String("uuid", "REQUIRED", "Identifier of source")
	...
	)
	{
		...
		case "ingest":
			...
			case "list-source-items":
				...
				data, err = ingestc.BuildListSourceItemsPayload(*ingestListSourceItemsBodyFlag, *ingestListSourceItemsUUIDFlag, *ingestListSourceItemsTokenFlag)
			}
		case "storage":
...
COMMAND:
    ...
    list-source-items: List the items in the given source
...
func ingestListSourceItemsUsage() {
	fmt.Fprintf(os.Stderr, `%[1]s [flags] ingest list-source-items -body JSON -uuid STRING -token STRING

List the items in the given source
    -body JSON: 
    -uuid STRING: Identifier of source
    -token STRING: 

Example:
    %[1]s ingest list-source-items --body '{
      "limit": 1,
      "page": "abc123"
   }' --uuid "d1845cb6-a5ea-474a-9ab8-26f9bcd919f5" --token "abc123"
`, os.Args[0])
