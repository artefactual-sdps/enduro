...
func NewClient(monitorRequest, monitor, listSips, showSip, listSipWorkflows, confirmSip, rejectSip, addSip, uploadSip, downloadSipRequest, downloadSip, listUsers, listSourceItems goa.Endpoint) *Client {
	return &Client{
