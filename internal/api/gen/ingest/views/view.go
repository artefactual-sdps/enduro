...
type Value struct {
	kind                    ValueKind
	IngestPingEvent         *IngestPingEventView
	SipCreatedEvent         *SIPCreatedEventView
	SipUpdatedEvent         *SIPUpdatedEventView
	SipStatusUpdatedEvent   *SIPStatusUpdatedEventView
	SipWorkflowCreatedEvent *SIPWorkflowCreatedEventView
	SipWorkflowUpdatedEvent *SIPWorkflowUpdatedEventView
	SipTaskCreatedEvent     *SIPTaskCreatedEventView
	SipTaskUpdatedEvent     *SIPTaskUpdatedEventView
	BatchCreatedEvent       *BatchCreatedEventView
	BatchUpdatedEvent       *BatchUpdatedEventView
}
...
func (u Value) AsIngestPingEvent() (_ *IngestPingEventView, ok bool) {
...
func (u *Value) SetIngestPingEvent(v *IngestPingEventView) {
...
func (u Value) AsSipCreatedEvent() (_ *SIPCreatedEventView, ok bool) {
...
func (u *Value) SetSipCreatedEvent(v *SIPCreatedEventView) {
...
func (u Value) AsSipUpdatedEvent() (_ *SIPUpdatedEventView, ok bool) {
...
func (u *Value) SetSipUpdatedEvent(v *SIPUpdatedEventView) {
...
func (u Value) AsSipStatusUpdatedEvent() (_ *SIPStatusUpdatedEventView, ok bool) {
...
func (u *Value) SetSipStatusUpdatedEvent(v *SIPStatusUpdatedEventView) {
...
func (u Value) AsSipWorkflowCreatedEvent() (_ *SIPWorkflowCreatedEventView, ok bool) {
...
func (u *Value) SetSipWorkflowCreatedEvent(v *SIPWorkflowCreatedEventView) {
...
func (u Value) AsSipWorkflowUpdatedEvent() (_ *SIPWorkflowUpdatedEventView, ok bool) {
...
func (u *Value) SetSipWorkflowUpdatedEvent(v *SIPWorkflowUpdatedEventView) {
...
func (u Value) AsSipTaskCreatedEvent() (_ *SIPTaskCreatedEventView, ok bool) {
...
func (u *Value) SetSipTaskCreatedEvent(v *SIPTaskCreatedEventView) {
...
func (u Value) AsSipTaskUpdatedEvent() (_ *SIPTaskUpdatedEventView, ok bool) {
...
func (u *Value) SetSipTaskUpdatedEvent(v *SIPTaskUpdatedEventView) {
...
func (u Value) AsBatchCreatedEvent() (_ *BatchCreatedEventView, ok bool) {
...
func (u *Value) SetBatchCreatedEvent(v *BatchCreatedEventView) {
...
func (u Value) AsBatchUpdatedEvent() (_ *BatchUpdatedEventView, ok bool) {
...
func (u *Value) SetBatchUpdatedEvent(v *BatchUpdatedEventView) {
...
func (u *Value) UnmarshalJSON(data []byte) error {
	...
	case string(ValueKindSipStatusUpdatedEvent):
		var v *SIPStatusUpdatedEventView
		if err := json.Unmarshal(raw.Value, &v); err != nil {
			return err
		}
		u.kind = ValueKindSipStatusUpdatedEvent
	...
	case string(ValueKindSipWorkflowCreatedEvent):
		var v *SIPWorkflowCreatedEventView
		if err := json.Unmarshal(raw.Value, &v); err != nil {
			return err
		}
		u.kind = ValueKindSipWorkflowCreatedEvent
	...
	case string(ValueKindSipWorkflowUpdatedEvent):
		var v *SIPWorkflowUpdatedEventView
		if err := json.Unmarshal(raw.Value, &v); err != nil {
			return err
		}
		u.kind = ValueKindSipWorkflowUpdatedEvent
...
func ValidateIngestEventView(result *IngestEventView) (err error) {
	...
	case "sip_created_event":
		actual, _ := result.Value.AsSipCreatedEvent()
		if actual != nil {
			if err2 := ValidateSIPCreatedEventView(actual); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	case "sip_updated_event":
		actual, _ := result.Value.AsSipUpdatedEvent()
		if actual != nil {
			if err2 := ValidateSIPUpdatedEventView(actual); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	case "sip_status_updated_event":
		actual, _ := result.Value.AsSipStatusUpdatedEvent()
		if actual != nil {
			if err2 := ValidateSIPStatusUpdatedEventView(actual); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	case "sip_workflow_created_event":
		actual, _ := result.Value.AsSipWorkflowCreatedEvent()
		if actual != nil {
			if err2 := ValidateSIPWorkflowCreatedEventView(actual); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	case "sip_workflow_updated_event":
		actual, _ := result.Value.AsSipWorkflowUpdatedEvent()
		if actual != nil {
			if err2 := ValidateSIPWorkflowUpdatedEventView(actual); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	case "sip_task_created_event":
		actual, _ := result.Value.AsSipTaskCreatedEvent()
		if actual != nil {
			if err2 := ValidateSIPTaskCreatedEventView(actual); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	case "sip_task_updated_event":
		actual, _ := result.Value.AsSipTaskUpdatedEvent()
		if actual != nil {
			if err2 := ValidateSIPTaskUpdatedEventView(actual); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	case "batch_created_event":
		actual, _ := result.Value.AsBatchCreatedEvent()
		if actual != nil {
			if err2 := ValidateBatchCreatedEventView(actual); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	case "batch_updated_event":
		actual, _ := result.Value.AsBatchUpdatedEvent()
		if actual != nil {
			if err2 := ValidateBatchUpdatedEventView(actual); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	}
