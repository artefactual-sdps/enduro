...
func (s *ProcessingWorkflowTestSuite) TestConfirmation() {
	...
	expectations["createTask"](s, expectationParams{
		TaskID:   uploadTaskID,
		TaskName: "Move AIP",
		TaskNote: "Moving to review bucket",
	})
	expectations["uploadAIP"](s, expectationParams{})
	expectations["completeTask"](s, expectationParams{
		TaskID:   uploadTaskID,
		TaskNote: "Moved to review bucket",
	})
	s.env.OnActivity(
	...
	s.env.OnActivity(
		...
		s.workflow.ingestsvc,
		workflowID,
		enums.WorkflowStatusPending,
	).Return(nil, nil)
	expectations["createTask"](s, expectationParams{
		TaskID:     reviewAIPTaskID,
		TaskName:   "Review AIP",
		TaskNote:   "Awaiting user decision",
		TaskStatus: ref.New(enums.TaskStatusPending),
	})
	s.env.OnActivity(
		setStatusLocalActivity,
		ctx,
	...
	s.env.OnActivity(
		...
		s.workflow.ingestsvc,
		workflowID,
		enums.WorkflowStatusInProgress,
	).Return(nil, nil)
	expectations["completeTask"](s, expectationParams{
		TaskID:   reviewAIPTaskID,
		TaskNote: "Reviewed and accepted",
	})
	expectations["createTask"](s, expectationParams{
...
func (s *ProcessingWorkflowTestSuite) TestRejection() {
	...
	expectations["completeTask"](s, expectationParams{
		TaskID:   reviewAIPTaskID,
		TaskNote: "Reviewed and rejected",
	})
	s.env.OnActivity(
...
func (s *ProcessingWorkflowTestSuite) TestFailedSIP() {
	...
	expectations["uploadToFailed"](s, expectationParams{
		UploadPath: prepDownloadPath + "/" + key,
		FailedKey:  failedSIPKey,
	})
	expectations["removePaths"](s, expectationParams{RemovePaths: []string{prepDownloadPath}})
	expectations["updateSIPFailed"](s, expectationParams{
		SIPStatus: enums.SIPStatusFailed,
...
func (s *ProcessingWorkflowTestSuite) TestFailedPIPA3m() {
	...
	expectations["removePaths"](s, expectationParams{})
	expectations["updateSIPFailed"](s, expectationParams{
		SIPStatus: enums.SIPStatusError,
...
func (s *ProcessingWorkflowTestSuite) TestFailedPIPAM() {
	...
	expectations["uploadToFailed"](s, expectationParams{
		UploadPath: extractPath + "/transfer.zip",
		FailedKey:  failedPIPKey,
	})
	expectations["removePaths"](s, expectationParams{
		RemovePaths: []string{tempPath, extractPath + "/transfer.zip"},
