...
type aipInfo struct {
	...
	// name is the filename of the compressed AIP generated by a3m.
	//
	// name is populated after a3m creates and stores the AIP and is used to
	// upload the AIP to the storage service.
	//
	// name is left blank when using AM as the preservation system because
