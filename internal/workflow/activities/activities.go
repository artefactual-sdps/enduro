...
const (
	...
	DeleteOriginalFromInternalBucketActivityName = "delete-original-from-internal-bucket-activity"
	DeleteOriginalFromSIPSourceActivityName      = "delete-original-from-sip-source-activity"
