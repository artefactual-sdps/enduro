...
export class StorageApi extends runtime.BaseAPI implements StorageApiInterface {
    ...
    async storageDownloadDeletionReportRaw(requestParameters: StorageDownloadDeletionReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.uuid === null || requestParameters.uuid === undefined) {
            throw new runtime.RequiredError('uuid','Required parameter requestParameters.uuid was null or undefined when calling storageDownloadDeletionReport.');
        }
        ...
        const response = await this.request({
            path: `/storage/deletion-reports/{uuid}/download`.replace(`{${"uuid"}}`, encodeURIComponent(String(requestParameters.uuid))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async storageDownloadDeletionReportRequestRaw(requestParameters: StorageDownloadDeletionReportRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.uuid === null || requestParameters.uuid === undefined) {
            throw new runtime.RequiredError('uuid','Required parameter requestParameters.uuid was null or undefined when calling storageDownloadDeletionReportRequest.');
        }
