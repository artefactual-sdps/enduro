...
/**
 * Check if a given object implements the StorageMoveNotValidResponseBody interface.
 */
export function instanceOfStorageMoveNotValidResponseBody(value: object): boolean {
    let isInstance = true;
