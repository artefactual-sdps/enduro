...
/**
 * Check if a given object implements the PackageConfirmNotValidResponseBody interface.
 */
export function instanceOfPackageConfirmNotValidResponseBody(value: object): boolean {
    let isInstance = true;
