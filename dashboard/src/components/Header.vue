...
const instLogo = import.meta.env.VITE_INSTITUTION_LOGO;
const instURL = import.meta.env.VITE_INSTITUTION_URL;
const instName = import.meta.env.VITE_INSTITUTION_NAME;
</script>
    ...
    <nav class="navbar navbar-expand-md p-0">
      <div class="container-fluid">
        ...
        <button
          ...
          :aria-label="
            (layoutStore.sidebarCollapsed ? 'Expand' : 'Collapse') +
            ' navigation'
          "
